    ...
    <div className="mx-auto flex min-h-[calc(100vh-8rem)] max-w-md flex-col justify-center px-4 py-12">
      ...
      >
        <div className="mb-8 text-center">
          <span className="font-urdu text-5xl text-gold">رجسٹر</span>
          <h1 className="mt-3 font-display text-2xl font-semibold text-white">Create your account</h1>
          <p className="mt-2 text-sm text-white/45">
            Save every character you recognise to your personal history
          </p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4">
          <label className="block">
            <span className="mb-1.5 block text-xs text-white/50">Full name</span>
            <div className="relative">
              <User className="absolute left-3 top-1/2 -translate-y-1/2 text-white/25" size={16} />
              <input
                type="text"
                required
                value={name}
